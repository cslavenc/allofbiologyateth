# -*- coding: utf-8 -*-
"""
Created on Sat Mar 24 12:19:55 2018
...
def CI_sim(input_file, fmin=200, fmax=5000, nelectrodes=20, tbin=6*10**-3, stepsize=5*10**-4):     # Runs the simulation with default settings
    """
    ...
    # Apply a hamming window on data
    #window = np.hamming(50000)
    #in_sound[0:50000] = in_sound[0:50000] * window
