...
setwd("~/Documents/Academic/Data/DSU_R/Chapter 06 (Correlation)")
...
# personalityMatrix<-as.matrix(personalityData[, c("studentN", "studentE", "studentO", "studentA", "studentC", "lecturerN", "lecturerE", "lecturerO", "lecturerA", "lecturerC")])

#run the correlation analysis:
# rcorr(personalityMatrix)

#or convert the dataframe into a matrix and run the correlation analysis in one:
# rcorr(as.matrix(personalityData[, c("studentN", "studentE", "studentO", "studentA", "studentC", "lecturerN", "lecturerE", "lecturerO", "lecturerA", "lecturerC")]))
